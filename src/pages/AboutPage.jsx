  ...
  return (
    <div>
      ...
      <div className="container mx-auto xl:px-0 px-4 xl:mb-0 xl:-translate-y-20 lg:-translate-y-16 -translate-y-12">
        ...
        {/* Produk dan Layanan */}
        <div className="container mx-auto lg:py-0 md:px-4 lg:px-6 mt-2">
          <div className="p-8 container mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 justify-center items-center gap-6">
