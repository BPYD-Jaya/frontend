...
import { Typography, ButtonGroup, Button, Input, Accordion, AccordionHeader, AccordionBody } from "@material-tailwind/react";
      ...
      <div className="px-4 lg:px-0">
        ...
        <div className="container mx-auto flex justify-start pt-4 xl:px-0">
          <div className="flex gap-2">
            <a href="/produk" className="text-wpigreen-50 hover:text-green-900 opacity-60">
              Product
            </a>
            <div>/</div>
            <p className="text-wpigreen-50 hover:text-green-900 font-bold">{product.product_name}</p>
          </div>
        </div>
        ...
        <div className="container mx-auto pt-4 ">
          <div className="grid grid-cols-1 xl:grid-cols-12 mb-16 gap-2 lg:gap-6">
            ...
            <div className=" col-span-1 lg:col-span-4 ">
              <div className={` ${isCardSticky ? "sticky transition-transform duration-200 ease-in-out top-[150px] " : ""}`}>
                <div className="pb-8 px-4 pt-4 border border-blue-gray-100 rounded-md shadow-md">
                  ...
                  <div className="border-b">
                    ...
                    <div className="flex flex-row">
                      <ButtonGroup size="md" className=" justify-start pb-4">
                        ...
                        <input type="number" value={quantity} onChange={(e) => handleQuantityChange(parseInt(e.target.value))} className="w-[45px] max-w-[45px] border items-center text-center" placeholder="Qty." />
                  ...
                  <div className="w-full flex items-center justify-center">
                    <a href={product.wa_link} className="w-full">
                      <Button type="button" className="ml-0 mb-[-10px] mt-4 bg-gradient-to-r from-wpigreen-100 to-wpigreen-200 text-white font-bold text-2xl py-2 px-4 h-12 w-full rounded-md">
                        <div className="flex justify-center items-center gap-3">
                          <img alt="" src={process.env.PUBLIC_URL + "/assets/whatsapp.png"} className="h-6" />
                          Hubungi Kami
                        </div>
                      </Button>
                    </a>
