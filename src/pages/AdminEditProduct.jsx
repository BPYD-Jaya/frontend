...
export default function AdminEditProduct() {
  ...
  useEffect(() => {
    if (productData) {
      ...
      setDescriptionInputs(productData.additional_info.length);
      setSpecification(productData.additional_info);
    }
  }, [productData]);
  ...
  const handleAddDescription = () => {
    ...
    setSpecification([...specification, { item: "", desc: "" }]);
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append("additional_info", specification);
        ...
        <div className="flex-grow h-full ml-4 md:ml-80 pt-10 mr-4">
          ...
          <div className="bg-white rounded-lg shadow-md grid grid-cols-12 p-8">
                  ...
                  <div className="pb-8">
                    <div className="pb-4">
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          newSpecification[index].item = e.target.value;
                    ...
                    <div className="pb-4">
                      <Input
                        ...
                        onChange={(e) => {
                          const newSpecification = [...specification];
                          newSpecification[index].desc = e.target.value;
                          setSpecification(newSpecification);
                        }}
                      />
                    </div>
            ...
            <div className="col-span-12 flex justify-end items-center">
              ...
              <a href="#" className="flex gap-2 text-wpigreen-500 ml-4 text-sm">
                <Button
                  type="submit"
