      ...
      <div className="flex-grow h-full ml-4 md:ml-80 pt-10 mr-4">
        ...
        <div className="bg-white mr-6 mb-6 pt-6 pb-6 pr-6 pl-6 rounded-lg shadow-md">
              ...
              <thead>
                <tr>
                  {TABLE_HEAD.map((head, index) => (
                    <th key={head} className="border-b border-blue-gray-100 bg-blue-gray-50 p-4 cursor-pointer">
                    ...
                    <td className="">
                      <div className="">
                        <a href={`/master-edit-kota/${data.id}`}>
                          <button type="button" className="ml-2 mb-[-10px] bg-orange-500 text-white font-bold px-4 h-10 rounded-md">
                        ...
                        <button type="button" className="ml-2 mb-[-10px] bg-red-500 text-white font-bold px-4 h-10 rounded-md" onClick={() => handleDelete(data.id)}>
                          <div className="flex justify-center items-center gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                              <path
                                strokeLinecap="round"
          ...
          <div className="mt-4 flex">
            <MasterPagination active={paginationData.current_page} onPageChange={paginate} totalItems={paginationData.total} itemsOnPage={paginationData.per_page} />
          </div>
        </div>
