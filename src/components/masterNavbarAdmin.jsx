...
export default function MasterNavbarAdmin({ setOpenSidebar, openSidebar }) {
  ...
  const fetchNotification = async () => {
    try {
      const res = await axios.get('http://127.0.0.1:8000/api/notification/email', {
        headers: {
      ...
      <div className="flex justify-end items-center shadow-sm gap-4 text-white relative pr-4">
        ...
        <div className="relative">
          ...
          {isNotificationDropdownOpen && (
            ...
            >
              {/* <li className=" w-full flex items-center gap-4 px-3 py-2 pl-2 pr-8 leading-tight transition-all rounded-md outline-none cursor-pointer select-none text-start hover:bg-blue-gray-50 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900">
                <img
                  alt="tania andrew"
                ...
                <div className="flex flex-col gap-1">
                  <p className="block font-sans text-sm antialiased font-semibold leading-normal text-gray-700">
                    PT Warung Pangan Indonesia <br /> send you a message
                  </p>
